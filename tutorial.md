...
**Kurubind** es una librería ligera que actúa como puente entre clases anotadas y JDBI, proporcionando operaciones CRUD automáticas, validación de datos, generación de valores, y un sistema extensible mediante handlers y generadores SQL.

## 🎯 Características Principales

- ✅ **Operaciones CRUD automáticas** sin SQL repetitivo
- ✅ **Validación de datos integrada** con validators extensibles
- ✅ **Generación automática de valores** (UUID, timestamps, códigos)
- ✅ **Sistema de handlers** para transformar datos
...
| `@Generated` | Generación automática con control fino | `@Generated(generator = "UUID", onInsert = true)` |

## 🔧 Value Generators

Los value generators permiten generar valores automáticamente:
...
- `CreatedAtGenerator` - Timestamp de creación
...
Kurubind acumula **todos** los errores antes de lanzar la excepción:
...
Optimiza SQL para dialectos específicos:
...
// Validators (los base ya están incluidos)
...
✅ Se extiende mediante interfaces claras  
✅ Proporciona validación y generación de valores integradas  
❌ No tiene lazy loading, cascadas, ni cache  
...
**Kurubind** - Simple, extensible, y poderoso. 🚀