...
public class KurubindDatabase {
    ...
    private EntityMetadata getMetadata(Class<?> entityClass) {
        ...
        // if absent, create and cache
        // if not absent, return cached
    ...
    public <T> void insert(T entity) {
        ...
        // execute
        // abre una transaction y llama al helper internoa
        execute(handle -> {
    ...
    public <T> void insertAll(List<T> entities) {
        ...
        // Opens a transaction and calls internal insert for each entity
        execute(handle -> entities.forEach(entity -> internalInsert(handle, entity, metadata)));
    }
    ...
    public <T> void updateAll(List<T> entities) {
        ...
        execute(handle -> entities.forEach(entity -> internalUpdate(handle, entity, metadata)));
